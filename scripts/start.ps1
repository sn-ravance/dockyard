...
Write-Host ""
Write-Success "Starting Dockyard..."
Write-Host ""
...
if ($containersRunning) {
    Write-Info "Dockyard is already running"
    Write-Host ""
    Write-Host "To restart, run: .\scripts\restart.ps1"
    Write-Host "To stop, run: .\scripts\stop.ps1"
    Write-Host ""
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  Dockyard is now running!" -ForegroundColor Green
    Write-Host "============================================" -ForegroundColor Green
    Write-Host ""
    Write-Host "Open your browser to: http://localhost:3030"
    Write-Host ""
    ...
    Write-Host ""
    Write-Error "Failed to start Dockyard"
    Write-Host ""
